...
$( "#greenled" ).click(function() {
    ...
    greenrequest.open('POST', 'https://io.adafruit.com/api/v2/Peaceful_Ferret/feeds/digital-output/data');
...
$( "#yellowled" ).click(function() {
	...
	yellowrequest.open('POST', 'https://io.adafruit.com/api/v2/Peaceful_Ferret/feeds/digital-output/data');
